...
my_volume.start_update_timer(1)

local cw = my_widgets.calendar()

local date = wibox.widget.textclock("%H:%M|%a %b %d %Y")
    ...
    s.mywibox:setup({
        {
            layout = wibox.layout.stack,
            {
                ...
                nil,
                {
                    ...
                    layout = wibox.layout.fixed.horizontal,
                    spacing = beautiful.spacing,
                    wrap_bg(wibox.widget.systray()), -- show runned background apps
                    wrap_bg({
                        layout = wibox.layout.fixed.horizontal,
                        my_volume,
